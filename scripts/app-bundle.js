...
define('text!shell/shell.html', ['module'], function(module) { module.exports = "<template><compose view=\"./sidebar.html\"></compose><compose view=\"./header.html\"></compose><div class=\"page-host\"><router-view></router-view></div></template>"; });
define('text!shell/sidebar.html', ['module'], function(module) { module.exports = "<template><compose view=\"./sidebar.html\"></compose><div class=\"main-nav\"><ul class=\"nav nav-list\"><li repeat.for=\"nav of router.navigation\" class=\"${nav.isActive ? 'active' : ''}\"><a href.bind=\"nav.href\"><i class=\"fa ${nav.settings.iconClass}\"></i></a></li></ul></div></template>"; });
